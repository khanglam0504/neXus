...
export function NotificationPanel({
  ...
  return (
    <div className="w-80 rounded-lg border border-border bg-popover shadow-xl">
              ...
              <div key={group.agentId}>
                <div className="flex items-center justify-between px-2 py-1.5">
                  <span className="text-xs font-semibold text-muted-foreground">
                    {group.agentName}
                    {group.unreadCount > 0 && (
                      <span className="ml-1.5 text-blue-500 dark:text-blue-400">({group.unreadCount} unread)</span>
                    )}
                  </span>
